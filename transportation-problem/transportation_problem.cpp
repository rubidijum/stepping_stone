                    ...
                    , std::vector<field> *solution)
{
    ...
    while (i < row && j < col) {
        ...
        if (offer[i] == demand[j]) {
            ...
            solution->push_back({{i,j}, offer[i]});
            ...
            offer[i] -= demand[j];
            solution->push_back({{i,j}, demand[j]});
...
std::vector<std::tuple<unsigned, unsigned, unsigned>> matrix2array(   const std::vector<std::vector<unsigned>> &matrix
                                                                    , const unsigned row
                                                                    , const unsigned col)
{
